...
* {
 ...
 html, body {
	 ...
	 background: #f3f2f2;
	 background-image: url("https://images.pexels.com/photos/669582/pexels-photo-669582.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1");
...
<style type="text/css">
    ...
    <form  id="login-form" class="log-in" autocomplete="off"> 
      <h4>We are <span style="font-size:20px"><b >BODY</b></span>
        <span style="font-size:20px">STATION GYM</span></h4>
      <p>Welcome back! Log in to your account to view clients credentials</p>
      <div class="floating-label">
        <input placeholder="Username"  name="username" autocomplete="off" id="username">
